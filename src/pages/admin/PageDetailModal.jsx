...
const Field = ({ label, value, onChange, type = 'text' }) => (
  <div className="grid grid-cols-3 gap-3 items-center">
    <label className="text-left text-sm font-medium text-gray-700 col-span-1">{label}</label>
    <input
      type={type}
      value={value}
...
const PublishedCheckboxes = ({ published, onChange }) => (
  <div className="grid grid-cols-3 gap-3 items-center">
    <label className="text-left text-sm font-medium text-gray-700 col-span-1">Published</label>
...
const PageDetailModal = ({ open, onClose, page, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="bg-white w-full max-w-lg rounded-xl shadow-lg h-[600px] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          />
          <div className="grid grid-cols-3 gap-3 items-center">
            <label className="text-left text-sm font-medium text-gray-700 col-span-1">Slug</label>
            <input
              type="text"
              value={form.slug}
            ...
            {editingSectionId ? (
              <div className="mt-3 p-4 rounded-lg border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-left text-sm font-medium text-gray-700">Type</label>
              ...
              <div className="mt-3 p-4 rounded-lg border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1">
                    <label className="text-left text-sm font-medium text-gray-700">New Section Label</label>
                    <input value={sectionDraft.label} onChange={(e) => setSectionDraft({ ...sectionDraft, label: e.target.value })} className="border border-gray-300 rounded-md px-3 py-2 text-sm" />
                  </div>
                  <div className="flex flex-col gap-1">
                    <label className="text-left text-sm font-medium text-gray-700">Type</label>
        ...
        <div className="flex items-center justify-end gap-3 px-5 py-4 border-t flex-none">
